var SoundSystem = (function ($, SFX, soundManager) {

    var module = {};

    module.SoundSystem = function SoundSystem(options) {
        this.init = function () {
            var that = this;
            this.settings = {
            ...
            $('.adjust-sound').each(function () {
                ...
                $(this).bind('slide slidestop', function () {
                    ...
                    if ($(this).hasClass('sfx')) {
                        // TODO: what's audio? I don't think it exists.
